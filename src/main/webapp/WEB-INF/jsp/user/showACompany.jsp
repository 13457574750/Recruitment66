                ...
                <div class="job-list-wrap mt-5">
                    ...
                    <ul class="pagination pagination-center mt-5">
                        <li class="page-item"><a class="page-link"
                                                 href="${path}/user/showACompany?companyId=${company.companyId}&companyName=${company.companyName}&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}"><i
                                class="fa fa-angle-left"></i></a></li>
                        <c:forEach begin="1" end="4" var="pageNum">
                            <li class="page-item "><a class="page-link"
                                                      href="${path}/user/showACompany?companyId=${company.companyId}&companyName=${company.companyName}&page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item"><a class="page-link"
                                                 href="${path}/user/showACompany?companyId=${company.companyId}&companyName=${company.companyName}&page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}"><i
